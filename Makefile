#
# OMNeT++/OMNEST Makefile for VKR1
#
# This file was generated with the command:
#  opp_makemake -f --deep -KINET_PROJ=/home/veins/Frameworks/inet-4.5.2/inet4.5 -KVEINS_PROJ=/home/veins/Frameworks/veins-5.2/veins-veins-5.2 -DINET_IMPORT -DVEINS_IMPORT -I$$\(INET_PROJ\)/src -I$$\(VEINS_PROJ\)/src -I. -L$$\(INET_PROJ\)/src -L$$\(VEINS_PROJ\)/src -lINET$$\(D\) -lveins$$\(D\)
#
...
OBJS = \
    $O/veins_inet/CarJamInet.o \
    $O/veins_inet/CarProbeRouting.o \
...
INET_PROJ=/home/veins/Frameworks/inet-4.5.2/inet4.5
VEINS_PROJ=/home/veins/Frameworks/veins-5.2/veins-veins-5.2
